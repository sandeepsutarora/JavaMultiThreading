...
public class SplitString {
	...
	public static void main(String[] args) throws Exception{
		...
		String IP = "23.45.12.5s6";
		String zeroTo255 = "(\\d{1,2}|(0|1)\\{2}|2[0-4]\\d|25[0-5])";
		String s1 = zeroTo255 + "\\." + zeroTo255 + "\\." + zeroTo255 +"\\." + zeroTo255;
		System.out.println(IP.matches(s1));
